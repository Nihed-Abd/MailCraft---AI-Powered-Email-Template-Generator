import '/components/add_color/add_color_widget.dart';
...
class SubmitPromptStep3Widget extends StatefulWidget {
  const SubmitPromptStep3Widget({
    super.key,
    required this.title,
  ...
  @override
  State<SubmitPromptStep3Widget> createState() =>
      _SubmitPromptStep3WidgetState();
}

class _SubmitPromptStep3WidgetState extends State<SubmitPromptStep3Widget>
    with TickerProviderStateMixin {
  late SubmitPromptStep3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SubmitPromptStep3Model());
