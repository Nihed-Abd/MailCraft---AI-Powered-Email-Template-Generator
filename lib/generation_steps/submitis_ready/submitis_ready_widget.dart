...
class SubmitisReadyWidget extends StatefulWidget {
  const SubmitisReadyWidget({
    super.key,
    required this.title,
  ...
  @override
  State<SubmitisReadyWidget> createState() => _SubmitisReadyWidgetState();
}

class _SubmitisReadyWidgetState extends State<SubmitisReadyWidget>
    with TickerProviderStateMixin {
  late SubmitisReadyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SubmitisReadyModel());
